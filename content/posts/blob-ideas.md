...
My blob is still pretty unstable and cpu-intensive in its current state, so there's still a lot of work to do in the future. For now, I think I've had enough blobbing for some while. Ping me on Discord if you have any new idea!
